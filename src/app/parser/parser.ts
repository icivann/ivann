 ...
 */
const getIndentation = (file: string): string | null => {
...
const isLineFunctionDefinition = (line: string): boolean => line.startsWith('def ');
const isLineIndented = (line: string, indentation: string): boolean => line.startsWith(indentation);

const parseFunctionSignature = (line: string): FunctionSignature | null => {
...
const parse = (str: string): Promise<ParsedFunction[]> => new Promise((resolve, reject) => {
