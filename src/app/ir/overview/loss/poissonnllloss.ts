...
export default class PoissonNLLLoss {
  ...
  public initCode(): string {
    return `nn.PoissonNLLLoss(log_input=${this.LogInput}, full=${this.Full}, size_average=${this.SizeAverage}, eps=${this.Eps}, reduce=${this.Reduce}, reduction='${this.Reduction}')`;
  }
}
